...
export default function NavControlsClient({
  ...
  return (
    ...
    >
      <div
        className={`w-full flex flex-row align-middle flex-1 text-center pt-4 md:px-4 md:pt-4 md:bg-transparent bg-gradient-to-t from-transparent from-0% via-black/90 via-20% to-black/90 ${pageTitleVisible ? "-translate-y-20 " : ""} transition-all duration-300`}
      >
        <div
        ...
        >
          ...
          <h3
            className={`hidden md:block w-full min-w-64 text-start text-lg mt-0.5 transition-all duration-300 ${pageTitleVisible ? "text-transparent translate-y-3" : "translate-y-0"}`}
          >
            {pageTitle}
          </h3>
        </div>
        <h3
          className={`block md:invisible w-full pb-2 text-center text-lg pt-6 mt-0.5 transition-all duration-300 ${pageTitleVisible ? "text-transparent translate-y-3" : "translate-y-0"}`}
        >
          {pageTitle}
        </h3>
        <div className="w-12" />
